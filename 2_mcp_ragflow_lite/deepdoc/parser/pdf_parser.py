...
# from rag.prompts.generator import vision_llm_describe_prompt  # RAGFlow Lite 不需要
def vision_llm_describe_prompt(**kwargs): return ""
...
class VisionParser(RAGFlowPdfParser):
    ...
    def __call__(self, filename, from_page=0, to_page=100000, **kwargs):
        ...
        for idx, img_binary in enumerate(self.page_images or []):
            ...
            # RAGFlow Lite: 跳过 vision LLM 图片描述
            text = ""
